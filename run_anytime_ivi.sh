...
#        --save_dir /home/tbbakke/c2st-e/results/mri/anytime_exp_jan18
#
#    echo
#} >> ${SLURM}
#
...
#  {
#      echo CUDA_VISIBLE_DEVICES=0 /home/tbbakke/anaconda3/envs/c2st/bin/python ${LOGS_DIR}/c2st-e/trainMRI_all.py \
#          --num_dataset_samples 10 --num_partitions 0 --num_epochs 30 --do_early_stopping True \
